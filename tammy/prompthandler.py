...
class PromptHandler:
    ...
    def handle_interpolation(self, iterations_per_frame, text_prompts, 
               max_frames, prompt_strength, guidance_scale,zoom_instrument, initial_fps):
        ...
        if key_frames:
            ...
            try:
                guidance_scale_series = get_inbetweens(
                    parameter_dicts['guidance_scale'],max_frames, integer=False
                )
            except RuntimeError as e:
                print(
                    "WARNING: You have selected to use key frames, but you have not "
            ...
            try:
                prompt_strength_series = get_inbetweens(
                    parameter_dicts['prompt_strength'],max_frames, integer=False
                )
            except RuntimeError as e:
                print(
                    "WARNING: You have selected to use key frames, but you have not "
        ...
        sequence_settings = {
            'text_prompts_series':text_prompts_series,
            'iterations_per_frame_series': iterations_per_frame_series,
            'guidance_scale_series': guidance_scale_series,
            'prompt_strength_series': prompt_strength_series
        }
